<template>
    ...
    <v-card style="width:450px;" outlined>
        ...
        <v-card-text>
            ...
            <Number label="CampsiteId" v-model="value.campsiteId" :editMode="editMode"/>
            <Date label="FromDate" v-model="value.fromDate" :editMode="editMode"/>
            <Date label="ToDate" v-model="value.toDate" :editMode="editMode"/>
