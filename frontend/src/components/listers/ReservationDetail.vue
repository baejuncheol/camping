<template>
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <div>
                <Number label="CampsiteId" v-model="item.campsiteId" :editMode="editMode" @change="change" />
            </div>
            <div>
                <Date label="FromDate" v-model="item.fromDate" :editMode="editMode" @change="change" />
            </div>
            <div>
                <Date label="ToDate" v-model="item.toDate" :editMode="editMode" @change="change" />
            </div>
            <div>
